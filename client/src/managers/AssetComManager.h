...
public:
    ...
    void doDownload(const QUrl &full_url, const QString& save_path, const QString& save_filename = QString(), const QUrlQuery &query_args = QUrlQuery(), const bool &use_token=false) override;
