...
public:
    ...
    void doUploadWithMultiPart(const QString &path, const QString& file_name, const QString& form_infos, const QVariantMap extra_headers = QVariantMap(), const bool &use_token=false) override;
