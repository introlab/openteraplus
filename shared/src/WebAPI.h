...
#define WEB_SESSIONTYPESERVICE_PATH         "/api/user/sessiontypes/services"
...
#define WEB_QUERY_DEVICE_REGISTER_KEY   "device_register_key"
...
#define WEB_QUERY_WITH_TESTTYPES    "with_tests_types"
