...
int ScreenDev::width() const
{
    return 0;
}

int ScreenDev::height() const
{
    return 0;
}
...
void ScreenDev::setWidth(const int width)
{
    Q_UNUSED(width)
}

void ScreenDev::resetWidth()
{

}

void ScreenDev::setHeight(const int height)
{
    Q_UNUSED(height)
}

void ScreenDev::resetHeight()
{
